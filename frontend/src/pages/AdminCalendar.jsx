...
export default function AdminCalendar() {
  ...
  const addTimeSlot = async () => {
    try {
      const time = prompt("Introduceți ora (HH:mm):");
      if (!time) return;
      ...
      console.error(err);
      setError("Eroare la adăugarea slotului");
    }
  };

  const onExport = () => {
    // dacă backend-ul e pe aceeași origine, merge direct așa
            ...
            <div className={`lg:col-span-1 ${cards.elevated}`}>
              ...
              {slots.length === 0 ? (
                <p className="text-gray-500 text-center py-6">
                  Nu există sloturi pentru această zi.
                </p>
              ) : (
                <div className="space-y-2">
                  {slots.map((slot) => (
                    <div
                      ...
                      className={`p-4 rounded-lg border-2 transition-all ${slot.free > 0
            ...
            <div className="lg:col-span-2">
              <div className={cards.elevated}>
                <h2 className="text-xl font-bold text-gray-900 mb-4">
                  📋 Rezervări — {selectedDate.toLocaleDateString("ro-RO", { year: 'numeric', month: 'long', day: 'numeric' })}
                </h2>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex gap-2 flex-wrap">
                              {res.paymentStatus === "paid" ? (
                                <span className={badges.success}>Plătit</span>
                              ) : (
                                <span className={badges.warning}>Neplătit</span>
                              )}
