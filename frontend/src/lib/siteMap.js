...
export const SITE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Fidelizare pagina", to: "/fidelizare/pagina", requiresAuth: true },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Comenzi complete", to: "/admin/comenzi-complete", roles: STAFF_ROLES },
      { label: "Calendar", to: "/admin/calendar", roles: STAFF_ROLES },
      { label: "Calendar livrare", to: "/admin/calendar-livrare", roles: STAFF_ROLES },
      { label: "Calendar view", to: "/admin/calendar-view", roles: STAFF_ROLES },
      ...
      { label: "Add produs", to: "/admin/add-produs", roles: STAFF_ROLES },
...
const CONTEXT_BRIDGES = [
  ...
  {
    matchPrefix: "/catalog",
    targets: ["/cart", "/constructor", "/personalizare", "/comanda"],
  },
  {
    matchPrefix: "/constructor",
    targets: ["/catalog", "/cart", "/personalizare", "/comanda"],
  },
];
