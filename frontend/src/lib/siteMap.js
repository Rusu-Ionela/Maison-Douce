...
export const ADMIN_NAV_GROUPS = [
  {
    id: "operatiuni",
    label: "Operatiuni",
    description: "Fluxurile zilnice de comenzi, calendar, inbox si coordonare.",
  },
  {
    id: "productie",
    label: "Productie",
    description: "Executie in laborator, retete, stocuri si materiale.",
  },
  {
    id: "catalog",
    label: "Catalog",
    description: "Produse, torturi si administrarea ofertei comerciale.",
  },
  {
    id: "relatie-clienti",
    label: "Relatie clienti",
    description: "Recenzii, fidelizare, cupoane si suport asistat.",
  },
  {
    id: "business-sistem",
    label: "Business & sistem",
    description: "Metrici, audit si controale administrative sensibile.",
  },
];
...
export const SITE_SECTIONS = [
  ...
  },
  {
    ...
    fullWidth: true,
    items: [
      { label: "Panou", to: "/admin", roles: STAFF_ROLES, group: "operatiuni" },
      { label: "Inbox unificat", to: "/admin/inbox", roles: STAFF_ROLES, group: "operatiuni" },
      { label: "Comenzi", to: "/admin/comenzi", roles: STAFF_ROLES, group: "operatiuni" },
      {
        label: "Comenzi personalizate",
        to: "/admin/comenzi-personalizate",
        roles: STAFF_ROLES,
        group: "operatiuni",
      },
      { label: "Calendar", to: "/admin/calendar", roles: STAFF_ROLES, group: "operatiuni" },
      {
        label: "Raport rezervari",
        to: "/admin/raport-rezervari",
        roles: STAFF_ROLES,
        group: "operatiuni",
      },
      { label: "Notificari", to: "/admin/notificari", roles: STAFF_ROLES, group: "operatiuni" },
      {
      ...
      {
        label: "Notificari foto",
        to: "/admin/notificari-foto",
        roles: STAFF_ROLES,
        group: "operatiuni",
      },
      { label: "Abonamente", to: "/admin/abonamente", roles: STAFF_ROLES, group: "operatiuni" },
      { label: "Productie", to: "/admin/production", roles: STAFF_ROLES, group: "productie" },
      {
        label: "Retete laborator",
        to: "/admin/retete",
        roles: STAFF_ROLES,
        group: "productie",
      },
      {
        label: "Contabilitate stoc",
        to: "/admin/contabilitate",
        roles: STAFF_ROLES,
        group: "productie",
      },
      { label: "Umpluturi", to: "/admin/umpluturi", roles: STAFF_ROLES, group: "productie" },
      { label: "Albume admin", to: "/admin/albume", roles: STAFF_ROLES, group: "productie" },
      { label: "Produse", to: "/admin/produse", roles: STAFF_ROLES, group: "catalog" },
      { label: "Torturi", to: "/admin/torturi", roles: STAFF_ROLES, group: "catalog" },
      {
        label: "Catalog admin",
        to: "/admin/catalog",
        roles: STAFF_ROLES,
      ...
      { label: "Adauga tort", to: "/admin/add-tort", roles: STAFF_ROLES, group: "catalog" },
      {
        label: "Asistent AI",
        to: "/admin/asistent-ai",
        roles: STAFF_ROLES,
        group: "relatie-clienti",
      },
      {
        label: "Intrebari AI",
        to: "/admin/asistent-ai/intrebari",
        roles: STAFF_ROLES,
        group: "relatie-clienti",
      },
      {
        label: "Fidelizare admin",
        to: "/admin/fidelizare",
        roles: ADMIN_ROLES,
        group: "relatie-clienti",
      },
      { label: "Cupoane", to: "/admin/cupoane", roles: ADMIN_ROLES, group: "relatie-clienti" },
      { label: "Recenzii", to: "/admin/recenzii", roles: ADMIN_ROLES, group: "relatie-clienti" },
      { label: "Rapoarte", to: "/admin/rapoarte", roles: ADMIN_ROLES, group: "business-sistem" },
      { label: "Statistici", to: "/admin/stats", roles: ADMIN_ROLES, group: "business-sistem" },
      { label: "Audit", to: "/admin/audit", roles: ADMIN_ROLES, group: "business-sistem" },
      {
        label: "Monitoring",
        to: "/admin/monitoring",
        roles: ADMIN_ROLES,
