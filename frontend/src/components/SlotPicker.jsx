...
export default function SlotPicker({ slots, date, value, onChange }) {
  ...
  if (!date) {
    return <div className="text-gray-500 text-sm">Selecteaza mai intai o data.</div>;
  }

  if (daySlots.length === 0) {
    return <div className="text-gray-500 text-sm">Nu exista intervale pentru aceasta zi.</div>;
  }
